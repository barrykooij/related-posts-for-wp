		...
		<div class="wrap">
			...
			<div class='rp4wp-step rp4wp-step-<?php echo $cur_step; ?>' rel='<?php echo $cur_step; ?>'>
				...
				<div class="rp4wp-box rp4wp-box-upgrade">
					...
					<p><?php printf( __( "%sMore information about Related Posts for WP Premium (opens in new window) »%s", 'related-posts-for-wp' ), '<a href="https://www.relatedpostsforwp.com/?utm_source=plugin&utm_medium=link&utm_campaign=upgrade-box" target="_blank">', '</a>' ); ?></p>
				</div>
