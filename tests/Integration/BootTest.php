...
use LV2\WordPress\RelatedPostsForWP\Settings\Controller;
...
final class BootTest extends TestCase {
	...
	public function test_every_module_exists(): void {
		...
		foreach ( Main::get()->modules() as $module ) {
	...
	public function test_settings_are_set_up_on_init(): void {
		$this->assertSame( 10, has_action( 'init', [ Controller::class, 'build' ] ) );
		$this->assertArrayHasKey( 'general', Main::get()->settings()->sections() );
	}
}
