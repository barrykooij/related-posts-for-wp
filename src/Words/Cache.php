...
class Cache {
	 ...
	 *
	 * A post without words keeps its previous words, like in 2.x.
	 *
	...
	public function save_post( int $post_id ): void {
		...
		$wpdb->query( $wpdb->prepare( 'INSERT INTO ' . Table::name() . " (post_id, word, weight, post_type ) VALUES {$values}", $params ) );
	}
	...
	/**
	 * The query for published posts of the supported post types without stored words.
	 *
